...
int     Mag_x_offset = 224,      Mag_y_offset = -26,     Mag_z_offset = -151;   // Hard-iron offsets
float   Mag_x_scale = 0.99,     Mag_y_scale = 1.0,     Mag_z_scale = 1.01;    // Soft-iron scale factors
...
// ----- Debug
#define Switch A1                       // Connect an SPST switch between A0 and GND to enable/disable tilt stabilazation
...
long LCD_heading_buffer = 0;
long LCD_pitch_buffer = 0;
long LCD_roll_buffer = 0;
  ...
  */
  ...
  switch (LCD_loop_counter)
  {
    ...
    case 15: // ----- Display 4th roll digit
      Serial.print(abs(LCD_roll_buffer) % 10);
      LCD_loop_counter = 0;
      break;
  }
}
